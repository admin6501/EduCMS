...
class CourseAdmin(admin.ModelAdmin):
    list_display = ("title", "owner", "category", "price_toman", "status", "is_free_for_all", "updated_at")
...
class LessonAdmin(admin.ModelAdmin):
    list_display = ("title", "course", "section", "position", "is_free", "created_at")
...
try:
    ...
    # Add allow_profile_edit / allow_security_edit to settingsapp_sitesetting
